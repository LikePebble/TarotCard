  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <main className="mx-auto w-full max-w-[860px] px-6 pb-8 pt-3 lg:px-12 lg:pb-24 lg:pt-[88px]">
        ...
        <h1 className="mt-1 font-serif text-[27px] font-semibold leading-[1.35] lg:mt-0 lg:text-[40px] lg:leading-[1.3]">
          무엇이 궁금한가요
        </h1>
        <div className="mt-[22px] border-t border-line lg:mt-10">
          {(spread ? focusOptionsFor(spread) : []).map((option) => (
            ...
            >
              <span className="font-serif text-[21px] font-medium group-hover:text-gold-soft lg:text-[26px]">
                {option.label}
              </span>
