...
export function HomeHero() {
  ...
  return (
    <div className="mt-4 flex flex-1 items-center justify-center lg:mt-0 lg:h-[480px] lg:flex-none">
      <div className="relative aspect-[2/3.4] w-full max-w-[248px] overflow-hidden rounded-xl bg-ink-2 shadow-[0_24px_60px_rgba(8,5,0,0.65)] lg:max-w-[320px] lg:rounded-[14px]">
        {index !== null ? (
          <Image
