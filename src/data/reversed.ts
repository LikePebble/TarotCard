...
export const reversedCards: Record<string, ReversedText> = {
  "the-fool": {
    ko: "역방향의 바보는 시작하려는 마음이 아직 발을 떼지 못한 상태를 비춥니다. 호기심은 있지만 준비가 따라오지 않았을 수 있습니다. 한 곳에 쏟아야 할 주의가 여러 갈래로 흩어진 때이기도 합니다.\n\n새로 벌이기보다 이미 벌여 둔 것을 먼저 살펴보세요. 무엇을 향해 가고 있었는지 다시 확인해 보세요. 그러면 같은 한 걸음도 훨씬 가벼워집니다.",
  ...
  "the-magician": {
    ko: "역방향의 마법사는 재능과 도구는 그대로인데 마음이 흔들리는 상태를 비춥니다. 생각이 어수선해 집중이 흩어질 수 있습니다. 자신의 능력을 의심하느라 가진 힘을 절반도 쓰지 못하는 때일 수도 있습니다.\n\n큰 결정이나 새 시도는 잠시 미뤄 보세요. 마음을 어지럽히는 것부터 정리해 보시기 바랍니다. 의지가 다시 한 곳으로 모이면 손안의 도구도 제 몫을 합니다. 언제든 다시 시작할 준비가 되어 있습니다.",
  ...
  "the-high-priestess": {
    ko: "역방향의 여사제는 안쪽의 조용한 목소리가 바깥의 소음에 묻힌 상태를 비춥니다. 마음이 뜨겁게 달아올라 차분함을 잃었을 수 있습니다. 겉으로 아는 것만으로 이미 다 안다고 여기기 쉬운 때이기도 합니다.\n\n결론을 서두르기 전에 한 겹 더 깊이 들어가 보세요. 조금 느리게, 조금 조용하게 머물러 보세요. 처음의 판단 아래에 있던 다른 답이 떠오를 수 있습니다.",
  ...
  "the-empress": {
    ko: "역방향의 여황제는 얽혀 있던 일이 풀리기 시작하는 흐름을 비춥니다. 가려져 있던 사실이 빛 속으로 나옵니다. 꼬였던 매듭도 하나씩 느슨해지는 때입니다. 다만 그 과정에서 마음이 이랬다저랬다 흔들릴 수 있습니다.\n\n드러나는 것을 애써 붙잡거나 밀어내지 말고 그대로 보이게 두세요. 결정을 자꾸 뒤집게 된다면 신호로 받아들여 보세요. 지금은 정하는 때가 아니라 밝혀지는 때일 수 있습니다.",
  ...
  "the-emperor": {
    ko: "역방향의 황제는 단단하던 질서가 조금 무르게 풀린 상태를 비춥니다. 엄격함 대신 너그러움이 앞서는 때일 수 있습니다. 또는 세우려는 틀이 아직 여물지 않아 일이 곳곳에서 걸릴 수 있습니다.\n\n지금은 권위로 밀어붙이기보다 부드러움이 더 많은 것을 지켜 줍니다. 다만 무엇을 위해 그 틀을 세우려 했는지는 놓치지 마세요. 구조는 조금 더 자란 뒤에 다시 세워도 늦지 않습니다.",
  ...
  "the-lovers": {
    ko: "역방향의 연인은 마음과 선택이 어긋나 있는 상태를 비춥니다. 관계나 계획이 뜻대로 이어지지 않을 수 있습니다. 진심과 다른 이유로 기울어진 선택 위에 선 때일 수도 있습니다.\n\n지금 붙잡고 있는 것이 정말 원하는 것인지 조용히 물어보세요. 어긋남은 실패라기보다, 무엇이 소중한지 다시 고르라는 초대일 수 있습니다. 방향이 맞으면 이어짐은 다시 가능해집니다.",
  ...
  "strength": {
    ko: "역방향의 힘은 부드러움과 단단함의 균형이 한쪽으로 기운 상태를 비춥니다. 억지로 밀어붙이며 힘으로 해결하려 할 수 있습니다. 반대로 자신을 믿지 못해 목소리를 잃은 때일 수도 있습니다.\n\n지금 필요한 것은 더 센 힘이 아니라 자신을 대하는 다정함입니다. 두려워하는 것을 달래듯 스스로를 달래 보세요. 조용한 용기는 사라진 것이 아니라 잠시 숨을 고르고 있을 뿐입니다.",
  ...
  "the-hermit": {
    ko: "역방향의 은둔자는 성찰을 위한 물러남이 숨어 있는 쪽으로 기운 상태를 비춥니다. 신중함이라 여긴 것이 이유를 잃은 조심스러움일 수 있습니다. 또는 두려움이 등불을 가리고 있는 때일 수 있습니다.\n\n혼자만의 시간이 무엇을 위한 것이었는지 다시 물어보세요. 얻을 것을 얻었다면 이제 문을 조금 열어도 됩니다. 등불은 감추라고 있는 것이 아니라 다음 걸음을 비추라고 있는 것입니다.",
  ...
  "the-star": {
    ko: "역방향의 별은 희망과 나 사이의 연결이 흐려진 상태를 비춥니다. 다 안다는 자신감으로 그 빛을 대수롭지 않게 여길 수 있습니다. 반대로 무엇을 해도 소용없다는 무력감에 잠긴 때일 수도 있습니다.\n\n하늘을 다시 올려다보는 데에는 대단한 계기가 필요하지 않습니다. 작은 회복 하나, 고요한 시간 하나면 충분합니다. 별은 꺼진 것이 아니라, 잠시 시선이 다른 곳에 가 있었을 뿐입니다.",
  ...
  "the-sun": {
    ko: "역방향의 태양은 빛이 사라진 것이 아니라 구름에 한 겹 가려진 상태를 비춥니다. 기쁨과 만족은 분명 곁에 있습니다. 하지만 그 온기가 온전히 느껴지지 않을 수 있습니다. 마음껏 누리기를 스스로 망설이는 때일 수도 있습니다.\n\n크고 완전한 행복을 기다리느라 작은 즐거움을 미루지 마세요. 흐린 날에도 해는 그 자리에 있습니다. 오늘 만난 작은 온기를 충분히 반기는 것에서 빛은 다시 넓어집니다.",
  ...
  "judgement": {
    ko: "역방향의 심판은 부름은 이미 들려왔는데 대답이 머뭇거리는 상태를 비춥니다. 새로워질 기회 앞에서 마음이 작아졌을 수 있습니다. 내려야 할 결정을 미룬 채 판단만 거듭하는 때일 수도 있습니다.\n\n스스로를 심판하는 데 힘을 다 쓰지 않아도 됩니다. 지난 일은 배움으로 남겨 두세요. 미뤄 둔 대답 가운데 가장 작은 것 하나에 먼저 응답해 보세요. 일어서는 일은 거기서 시작됩니다.",
  ...
  "the-world": {
    ko: "역방향의 세계는 마무리되어야 할 순환이 아직 닫히지 못한 상태를 비춥니다. 거의 다 왔지만 마지막 한 걸음이 미뤄지고 있을 수 있습니다. 끝난 줄 알았던 일이 여전히 마음 한켠을 차지하는 때이기도 합니다.\n\n무엇이 완결을 미루고 있는지 가만히 살펴보세요. 서두를 필요는 없습니다. 남은 매듭 하나를 정직하게 지어 보세요. 그러면 멈춘 듯 보이던 흐름도 다시 움직일 자리를 찾습니다.",
  ...
  "two-of-cups": {
    ko: "역방향의 컵 2는 두 마음이 만나야 할 자리에서 미묘하게 어긋나 있는 상태를 비춥니다. 주고받음의 균형이 한쪽으로 기울었을 수 있습니다. 하고 싶은 말이 서로에게 닿지 못하고 각자의 안에 머문 때이기도 합니다.\n\n큰 화해보다 작은 정직이 먼저입니다. 마음에 담아 둔 것 하나를 부드럽게 꺼내 보세요. 연결은 끊어진 것이 아니라, 다시 이어 줄 손길을 기다리고 있을 뿐입니다.",
  ...
  "four-of-cups": {
    ko: "역방향의 컵 4는 오래 머물던 권태가 걷히기 시작하는 상태를 비춥니다. 시들해 보이던 자리에 새로운 관심이 스며듭니다. 낯선 사람이나 배움이 조용히 다가오는 때이기도 합니다.\n\n닫아 두었던 초대장을 다시 열어 보세요. 예전엔 눈에 들어오지 않던 것이 지금은 다르게 보일 수 있습니다. 마음이 다시 궁금해하기 시작했다는 것, 그 자체가 이미 좋은 신호입니다.",
  ...
  "five-of-cups": {
    ko: "역방향의 컵 5는 상실의 자리에서 시선이 다시 밖으로 향하기 시작하는 상태를 비춥니다. 소식이 닿고 인연이 돌아오는 흐름입니다. 다만 그 기대 가운데 일부는 마음이 그려 낸 그림일 수 있습니다.\n\n돌아오는 것을 반갑게 맞이하되, 하나하나 천천히 확인해 보세요. 진짜 위로와 서둘러 붙잡은 희망을 가려내 보세요. 그러면 회복의 걸음은 훨씬 단단해집니다.",
  ...
  "ten-of-cups": {
    ko: "역방향의 컵 10은 겉으로는 평온해 보이는 자리 안쪽의 어긋남을 비춥니다. 화목해 보이려는 마음이 진짜 대화를 대신하고 있을 수 있습니다. 참아 온 서운함이 보이지 않는 곳에서 자라는 때이기도 합니다.\n\n조화를 지키려고 눌러 둔 말이 있다면 꺼내 보세요. 가장 안전하게 느껴지는 사람에게서부터 시작해 보시기 바랍니다. 잠깐의 불편한 정직이, 오래 이어질 진짜 평화의 자리를 만들어 줍니다.",
  ...
  "page-of-cups": {
    ko: "역방향의 컵 페이지는 마음을 끄는 것의 겉과 속이 다를 수 있음을 비춥니다. 다정해 보이는 말이나 솔깃한 소식이 꾸며진 것일 수 있습니다. 나 스스로 감정을 실제보다 예쁘게 포장한 때이기도 합니다.\n\n느낌 자체를 의심하거나 버릴 필요는 없습니다. 다만 그 느낌이 어디서 왔는지 한 번 더 차분히 물어봐 주세요. 반짝임을 걷어 내고도 남아 있는 것이 진짜입니다.",
  ...
  "knight-of-cups": {
    ko: "역방향의 컵 나이트는 낭만이 실체보다 앞서 있는 상태를 비춥니다. 다가오는 제안이나 고백이 보이는 것만큼 진실하지 않을 수 있습니다. 말은 아름답지만 행동이 따라오지 않는 때이기도 합니다. 혹은 나 스스로 이상에 취해 현실 확인을 미뤄 두고 있는지도 모릅니다.\n\n마음을 닫으라는 뜻은 아닙니다. 다만 약속은 말이 아니라 시간이 증명하게 두세요. 천천히 지켜보아도 진짜인 것은 사라지지 않습니다.",
  ...
  "queen-of-cups": {
    ko: "역방향의 컵 퀸은 깊은 감수성이 물길을 잃은 상태를 비춥니다. 남의 마음을 돌보느라 내 마음이 비어 갈 수 있습니다. 감정이 흘러넘쳐 판단까지 물들이는 때이기도 합니다. 곁의 다정함이 늘 진심은 아닐 수 있다는 신호이기도 합니다.\n\n다정함을 버릴 필요는 없지만, 연민에도 가장자리가 필요합니다. 먼저 자신의 컵을 채워 보세요. 느낌만이 아니라 사실도 함께 살펴본 뒤에 정하시기 바랍니다.",
  ...
  "king-of-cups": {
    ko: "역방향의 컵 킹은 감정의 성숙이 뒤집힌 자리를 비춥니다. 침착해 보이는 얼굴 뒤에 다른 계산이 있을 수 있습니다. 너그러워 보이는 태도가 마음을 움직이려는 수단일 수도 있습니다. 혹은 나 자신이 감정을 누른 채 괜찮은 척하고 있는지도 모릅니다.\n\n평온함이나 권위만으로 사람을 믿지는 마세요. 그리고 스스로에게는, 눌러 둔 감정에도 이름을 붙여 주시기 바랍니다.",
  ...
  "ace-of-pentacles": {
    ko: "역방향의 펜타클 에이스는 풍요가 나를 든든하게 하는 대신 무겁게 하는 상태를 비춥니다. 기회가 생겨도 계산이 앞서 즐거움이 사라질 수 있습니다. 가진 것을 지키는 일이 원하는 삶보다 커진 때이기도 합니다.\n\n돈과 안정 자체가 문제는 아닙니다. 다만 그것이 무엇을 위한 것이었는지 다시 물어봐 주세요. 목적이 제자리를 찾으면, 같은 풍요도 사뭇 다르게 느껴집니다.",
  ...
  "two-of-pentacles": {
    ko: "역방향의 펜타클 2는 균형 잡는 솜씨가 한계에 다다른 상태를 비춥니다. 괜찮은 척 웃고 있지만 실은 버거운 때일 수 있습니다. 여러 일을 굴리는 것이 재주가 아니라 의무가 된 때이기도 합니다. 시간이든 돈이든 나가는 쪽이 많아 셈이 빠듯해지기도 합니다.\n\n버티는 것만이 능력은 아닙니다. 모든 공을 계속 띄워 둘 필요는 없습니다. 하나쯤 내려놓아도 무너지지 않습니다. 어느 것이 정말 내 손에 있어야 하는지부터 다시 골라 보세요.",
  ...
  "five-of-pentacles": {
    ko: "역방향의 펜타클 5는 어려움 위에 어수선함이 겹친 상태를 비춥니다. 부족한 가운데 씀씀이나 마음이 흐트러져 있을 수 있습니다. 힘든 시기를 함께 견딜 사람들 사이에 불화가 스미는 때이기도 합니다.\n\n모든 것을 한 번에 되돌리려 하지 마세요. 오늘 정돈할 수 있는 한 가지부터 손보는 것으로 충분합니다. 작은 질서가 돌아오면, 도움도 길도 다시 보이기 시작합니다.",
  ...
  "six-of-pentacles": {
    ko: "역방향의 펜타클 6은 주고받음의 흐름이 어딘가에서 어긋난 상태를 비춥니다. 남의 몫과 내 몫을 자꾸 견주게 될 수 있습니다. 베풂에 조건이 붙거나 공정해 보이던 저울이 기울었을 수도 있습니다.\n\n지금 오가는 것들의 셈을 잠시 내려놓아 보세요. 내가 무엇을 바라며 주고 있었는지 살펴보세요. 무엇이 부러움으로 남았는지 알아차리는 것만으로도 흐름은 다시 순해집니다.",
  ...
  "eight-of-pentacles": {
    ko: "역방향의 펜타클 8은 일과 나 사이가 조금 헐거워진 상태를 비춥니다. 손은 여전히 움직이는데 왜 하는지가 흐려졌을 수 있습니다. 솜씨가 보여 주기나 잇속 쪽으로 기울어 일의 기쁨이 옅어진 때일 수도 있습니다.\n\n처음 이 일이 좋았던 순간을 떠올려 보세요. 누구에게 보이기 위한 작업은 잠시 내려놓아 보세요. 나를 위해 다듬는 작은 작업으로 돌아가면 흐려졌던 이유가 다시 또렷해집니다.",
  ...
  "nine-of-pentacles": {
    ko: "역방향의 펜타클 9는 스스로 일군 안정에 어딘가 미덥지 못한 구석이 있음을 비춥니다. 믿고 맡긴 것이 약속대로 굴러가지 않을 수 있습니다. 겉으로는 여유로워 보여도 기반의 한 곳이 비어 있는 때일 수도 있습니다.\n\n누리던 것을 잠시 멈추고 토대를 점검해 보세요. 어떤 약속 위에 서 있는지 확인해 보시기 바랍니다. 그 약속이 아직 유효한지 살피는 일은 의심이 아닙니다. 자신을 지키는 정돈입니다.",
  ...
  "ten-of-pentacles": {
    ko: "역방향의 펜타클 10은 오래 쌓아 온 안정이 운에 기대어 흔들리는 상태를 비춥니다. 지켜야 할 것을 확률에 걸고 있을 수 있습니다. 든든하다고 믿었던 기반에서 뜻밖의 허점이 드러나는 때일 수도 있습니다.\n\n크게 벌이기보다 지키는 쪽으로 무게를 옮겨 보세요. 나와 곁의 사람들에게 정말 남겨야 할 것을 가려내세요. 그러면 흔들림 속에서도 붙들 기둥이 분명해집니다.",
  ...
  "knight-of-pentacles": {
    ko: "역방향의 펜타클 나이트는 꾸준함이 어느새 제자리걸음으로 굳어 버린 상태를 비춥니다. 성실하게 반복하지만 나아가는 감각이 사라졌을 수 있습니다. 지루함과 낙심 속에 손끝의 정성이 무뎌진 때일 수도 있습니다.\n\n멈춘 것이 게으름만은 아닙니다. 같은 길을 너무 오래 걸었다는 신호일 수 있습니다. 익숙한 순서를 아주 조금만 바꿔 보세요. 작은 변화가 무거워진 걸음을 다시 풀어 줍니다.",
  ...
  "queen-of-pentacles": {
    ko: "역방향의 펜타클 퀸은 돌보는 마음이 걱정과 의심 쪽으로 기울어 버린 상태를 비춥니다. 곁을 살피던 눈길이 못 미더움으로 바뀌었을 수 있습니다. 남을 챙기느라 자신의 안녕은 뒷전이 된 때일 수도 있습니다. 그러면서 마음만 졸이고 있을 수 있습니다.\n\n먼저 자신을 식탁에 앉혀 주세요. 잘 먹고 잘 쉬어 몸을 안심시켜 주세요. 그러면 흐릿하던 의심 가운데 무엇을 살펴봐야 할지도 또렷해집니다.",
  ...
  "ace-of-swords": {
    ko: "역방향의 소드 에이스는 명료함의 칼이 지나치게 세게 휘둘리는 상태를 비춥니다. 옳은 말이 상처를 내는 도구가 되었을 수 있습니다. 하나의 생각을 밀어붙이다가 상황을 열기보다 베어 버린 때일 수도 있습니다.\n\n칼끝을 잠시 내려 보세요. 그 통찰이 틀린 것이 아니라, 힘과 때가 맞지 않았을 뿐입니다. 무엇을 위해 이 명료함을 쓰려 했는지 되짚어 보세요. 그러면 같은 진실도 다르게 전할 수 있습니다.",
  ...
  "two-of-swords": {
    ko: "역방향의 소드 2는 미뤄 둔 결정이 어느새 감춤으로 이어진 상태를 비춥니다. 균형처럼 보이던 침묵 속에 말하지 않은 것들이 쌓였을 수 있습니다. 나에게든 상대에게든 온전히 정직하지 못한 채 선 때일 수도 있습니다.\n\n모든 것을 한꺼번에 밝히지 않아도 됩니다. 다만 스스로에게만은 지금 무엇을 피하고 있는지 이름을 붙여 보세요. 거기서부터 눈가리개가 느슨해집니다.",
  ...
  "three-of-swords": {
    ko: "역방향의 소드 3은 아픔이 정리되지 못한 채 머릿속을 어지럽히는 상태를 비춥니다. 상처보다 그 주위를 맴도는 생각들이 더 소란스러울 수 있습니다. 혼란 속에서 잘못 짚은 판단이 겹치는 때일 수도 있습니다.\n\n생각으로 아픔을 풀어내려는 손을 잠시 쉬게 해 주세요. 무엇이 아팠는지 한 문장으로만 적어 보는 것으로 충분합니다. 어지러운 실타래는 이름이 붙는 순간부터 풀리기 시작합니다.",
  ...
  "five-of-swords": {
    ko: "역방향의 소드 5는 이미 끝난 다툼이 마음속에서는 아직 끝나지 않은 상태를 비춥니다. 이겼든 졌든 그 싸움이 남긴 것을 계속 되새길 수 있습니다. 떠나보내지 못한 감정이 자리를 차지한 때일 수도 있습니다.\n\n그 갈등을 정식으로 배웅해 주세요. 잃은 것을 인정하고 애도하는 일은 지는 것이 아니라 끝맺는 것입니다. 묻어 준 자리에서만 다음 것이 자랍니다.",
  ...
  "six-of-swords": {
    ko: "역방향의 소드 6은 조용히 건너가려던 것이 말이 되어 나오려는 상태를 비춥니다. 혼자 삭이던 마음이 고백이나 선언을 요구할 수 있습니다. 덮어 두었던 사정이 드러나는 때일 수도 있습니다. 그중에는 전하고 싶었던 애정도 있습니다.\n\n말이 되려는 것을 억지로 붙들지 마세요. 언제, 누구에게, 어디까지 말할지는 고를 수 있습니다. 스스로 고른 자리에서 꺼낸 말은 무겁지 않습니다.",
  ...
  "seven-of-swords": {
    ko: "역방향의 소드 7은 주위에 말이 많아진 때를 비춥니다. 귀담아들을 조언과 흘려보낼 소문이 한데 섞여 들어옵니다. 어느 말이 나를 위한 것인지 가려내기 어려운 상태일 수 있습니다.\n\n말의 내용만큼 말하는 사람을 살펴보세요. 내 사정을 알고 하는 말인지, 자기 이야기를 하고 있는 것인지요. 고른 조언 하나가 열 갈래 소음보다 멀리 데려다줍니다.",
  ...
  "eight-of-swords": {
    ko: "역방향의 소드 8은 매여 있던 자리가 흔들리기 시작한 때를 비춥니다. 다만 그 흔들림이 예상 밖의 방향에서 올 수 있습니다. 풀려나는 중인지 더 얽히는 중인지 분간하기 어려워 불안한 상태일 수 있습니다.\n\n모든 변수를 붙들려 하기보다, 지금 확실한 것 몇 가지를 짚어 보세요. 발밑이 어수선할수록 한 번에 한 걸음이 가장 빠른 길입니다.",
  ...
  "ten-of-swords": {
    ko: "역방향의 소드 10은 바닥을 지나 형편이 나아지기 시작한 때를 비춥니다. 도움이 닿고 일이 풀리는 기색이 보입니다. 다만 지금의 순풍은 아직 자리를 잡는 중입니다.\n\n좋아지는 흐름은 감사히 타되, 그 위에 모든 것을 세우지는 마세요. 바람이 부는 동안 기초를 다져 두면, 이 회복은 지나가는 운이 아니라 당신의 것이 됩니다.",
  ...
  "page-of-swords": {
    ko: "역방향의 소드 페이지는 예리한 호기심이 방향을 잃은 상태를 비춥니다. 질문이 캐물음이 되고 관찰이 의심으로 기울었을 수 있습니다. 지켜보기만 하다가 준비 없이 일을 맞닥뜨리는 때일 수도 있습니다. 몸이 보내는 신호를 놓치고 있을 수도 있습니다.\n\n모으기만 한 정보를 한번 정리해 보세요. 무엇을 알고 싶었는지 분명히 해 보시기 바랍니다. 그러면 날 선 경계는 다시 쓸모 있는 총명함으로 돌아옵니다.",
  ...
  "knight-of-swords": {
    ko: "역방향의 소드 나이트는 속도가 방향을 앞질러 버린 상태를 비춥니다. 밀어붙이는 힘은 넘치지만 준비나 판단이 따라오지 못할 수 있습니다. 필요 이상으로 세게 나아가며 힘을 흘려보내는 때일 수도 있습니다.\n\n달리기 전에 고삐를 한 번 쥐어 보세요. 지금 어디로 가고 있는지 확인해 보시기 바랍니다. 이 속도를 감당할 준비가 됐는지 살피는 잠깐의 멈춤이 긴 우회를 줄여 줍니다.",
  ...
  "queen-of-swords": {
    ko: "역방향의 소드 퀸은 맑아야 할 시선이 차갑게 굳어 있는 상태를 비춥니다. 상처를 막으려던 날카로움이 사람을 밀어내는 말이 되었을 수 있습니다. 의심이 판단보다 한발 앞서 움직이는 때일 수도 있습니다.\n\n칼끝을 잠시 내려놓고, 그 엄격함이 본래 무엇을 지키려던 것이었는지 떠올려 보세요. 정확함을 잃지 않아도 됩니다. 조금 더 따뜻한 언어를 고를 여유는 아직 남아 있습니다.",
  ...
  "king-of-swords": {
    ko: "역방향의 소드 킹은 판단의 힘이 온기를 잃은 상태를 비춥니다. 원칙이 사람을 지키는 대신 누르는 도구가 되었을 수 있습니다. 옳음을 앞세운 말이 상대를 몰아세우는 때일 수도 있습니다. 그런 힘 앞에 서 있는 자신을 비추는 경우이기도 합니다.\n\n지금 내리려는 결정이 정말 공정한지 살펴보세요. 그저 단호해 보이고 싶은 것은 아닌지도 나누어 보시기 바랍니다. 힘은 지킬 것을 지킬 때 가장 단단해집니다.",
  ...
  "ace-of-wands": {
    ko: "역방향의 완드 에이스는 불씨가 아직 불로 옮겨붙지 못한 상태를 비춥니다. 시작하려던 일이 힘을 잃고 주저앉았을 수 있습니다. 기쁜 일에도 흐린 기운이 함께 섞인 때일 수도 있습니다.\n\n꺼진 것이 아니라 눌려 있는 것일 수 있습니다. 무엇이 이 불씨를 누르고 있는지 살펴보세요. 지금은 크게 벌이기보다 불씨를 지키는 쪽에 마음을 두어 보세요. 바람이 바뀌면 같은 불씨가 다시 타오릅니다.",
  ...
  "three-of-wands": {
    ko: "역방향의 완드 3은 길었던 어려움이 서서히 걷혀 가는 자리를 비춥니다. 애쓴 만큼의 결실이 아직 다 보이지 않아 실망이 남을 수 있습니다. 다만 흐름은 이미 풀리는 쪽으로 돌아서고 있습니다.\n\n멀리 내보낸 배가 항구로 돌아오는 데는 시간이 걸립니다. 지금은 성과를 재촉하지 마세요. 지나온 수고를 스스로 인정하고 숨을 고르며 다음 물때를 기다려 보세요.",
  ...
  "six-of-wands": {
    ko: "역방향의 완드 6은 기다리던 좋은 소식이 자꾸 미뤄지는 자리를 비춥니다. 이룬 것을 잃을까 하는 불안이 문 앞을 서성일 수 있습니다. 믿었던 지지가 예전 같지 않게 느껴지는 때일 수도 있습니다.\n\n불안은 성문을 지키게도 하지만, 오지 않은 적을 만들어 내기도 합니다. 소식이 늦어지는 지금은 바깥의 인정을 잠시 내려놓아 보세요. 스스로 이미 아는 자신의 몫을 하나씩 먼저 세어 보시기 바랍니다.",
  ...
  "seven-of-wands": {
    ko: "역방향의 완드 7은 지켜야 할 자리에서 마음이 갈피를 잡지 못하는 상태를 비춥니다. 사방에서 요구가 밀려와 어지러울 수 있습니다. 어느 것부터 막아야 할지 몰라 불안만 커진 때일 수도 있습니다.\n\n지금 가장 조심해야 할 것은 공격이 아니라 망설임입니다. 전부를 완벽하게 지키려 하지 마세요. 정말 놓칠 수 없는 한 가지를 먼저 정하고, 그 자리에 단단히 발을 딛어 보세요.",
  ...
  "eight-of-wands": {
    ko: "역방향의 완드 8은 멀리 날아가야 할 화살이 가까운 곳에 떨어지는 상태를 비춥니다. 바깥으로 뻗어야 할 기세가 질투나 사소한 다툼으로 바뀔 수 있습니다. 마음에 걸리는 후회가 가까운 관계 안에서 부딪히는 때일 수도 있습니다.\n\n날 선 말이 오가기 전에, 이 조급함이 어디에서 왔는지 먼저 짚어 보세요. 방향을 다시 바깥의 목표로 돌려 보세요. 그러면 같은 에너지가 다툼 대신 추진력이 됩니다.",
  ...
  "nine-of-wands": {
    ko: "역방향의 완드 9는 버티는 힘이 바닥을 보이기 시작한 자리를 비춥니다. 장애물이 잇달아 나타나 지칠 수 있습니다. 늘 통하던 방어가 이번에는 잘 버티지 못한다고 느낄 수도 있습니다.\n\n버티는 것만이 강함은 아닙니다. 모든 것을 혼자 막으려 하지 마세요. 잠시 물러나 상처를 돌보고 도움을 청할 곳을 찾아보시기 바랍니다. 쉬어 가는 것도 싸움을 이어 가는 한 방법입니다.",
  ...
  "ten-of-wands": {
    ko: "역방향의 완드 10은 무거운 짐에 얽힌 사정까지 더해진 상태를 비춥니다. 일이 자꾸 어긋날 수 있습니다. 겉으로 드러나지 않는 이해관계나 복잡한 사정이 걸음을 더 무겁게 할 수도 있습니다.\n\n짊어진 것을 전부 내려놓을 수는 없어도, 하나씩 꺼내어 볼 수는 있습니다. 이 가운데 정말 내 몫인 짐이 무엇인지 차분히 가려내세요. 아닌 것은 본래의 자리로 돌려보내 주세요.",
  ...
  "page-of-wands": {
    ko: "역방향의 완드 페이지는 반갑지 않은 소식이나 어수선한 말들이 마음을 흔드는 때를 비춥니다. 이야기가 이야기를 낳아 어디까지 믿어야 할지 모를 수 있습니다. 그 속에서 결정이 자꾸 미뤄지는 상태일 수도 있습니다.\n\n모든 말에 일일이 마음을 내어 주지 않아도 됩니다. 확인된 것과 소문을 나누어 보세요. 작은 것 하나라도 스스로 정해 보시기 바랍니다. 정한 만큼 흔들림은 줄어듭니다.",
  ...
  "knight-of-wands": {
    ko: "역방향의 완드 나이트는 힘차게 달리던 길이 중간에 끊긴 상태를 비춥니다. 진행되던 일이 갑자기 멈추었을 수 있습니다. 함께 가던 사람과의 사이에 균열이 생겨 마음이 들끓는 때일 수도 있습니다.\n\n끊긴 자리에서 무리하게 다시 내달리면 같은 곳이 또 끊어지기 쉽습니다. 무엇이 이 단절을 만들었는지 먼저 찬찬히 살펴보세요. 다시 이어 붙일 것과 놓아줄 것을 구분해 보시기 바랍니다.",
  ...
  "queen-of-wands": {
    ko: "역방향의 완드 퀸은 따뜻함이 사라진 상태를 뜻하지 않습니다. 그 따뜻함이 조금 더 조심스럽고 실속 있는 모습으로 바뀐 상태를 비춥니다. 아끼고 챙기는 마음은 여전합니다. 다만 상황에 따라 질투나 경계심이 섞여 들 수 있습니다.\n\n베풀던 마음이 서운함으로 바뀌려 할 때는 잠시 멈춰 보세요. 무엇을 바라고 있었는지 솔직하게 들여다보세요. 그러면 온기는 본래의 자리로 돌아옵니다.",
  ...
  "king-of-wands": {
    ko: "역방향의 완드 킹은 선한 뜻이 엄격한 모습으로 나타나는 상태를 비춥니다. 마음은 너그럽지만 겉으로는 딱딱하고 단호해 보일 수 있습니다. 자신에게든 곁의 사람에게든 기준을 높이 세운 때일 수도 있습니다.\n\n엄격함이 나쁜 것은 아니지만, 그 안의 온기가 전해지지 않으면 거리만 남습니다. 기준을 낮추지 않아도 좋습니다. 그 기준이 아끼는 마음에서 나왔다는 것을 말로 표현해 보세요.",
